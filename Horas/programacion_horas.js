...
function calcular(){
    ...
    var diario_trabajo = document.getElementById("diario_trabajo").value = parseFloat(salario_normal) / parseFloat(8) + "Bs.S";
    var descanso_trabajo = document.getElementById("descanso_trabajo").value = parseFloat(diario_trabajo) / parseFloat(0.50) + "Bs.S";
    var feriado_trabajo = document.getElementById("feriado_trabajo").value = parseFloat(salario_normal) / parseFloat(diario_trabajo) / parseFloat(0.30) + "Bs.S";
    ...
    if(diario.checked == true && dia_descanso.checked == true){
        ...
        alert("Has activado dos casilla hora normal y horas extras");
        ...
        alert("Has activado dos casilla hora normal y horas nocturnas");
        ...
        alert("Has activado dos casilla horas extras y horas nocturnas");
    ...
    if(diario.checked == true && dia_descanso.checked == true && dia_feriado.checked == true){
        ...
        alert("Has activado tres casilla, hora normal, hora extras y hora nocturnas");
